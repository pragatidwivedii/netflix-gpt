...
import { addMovieSuggestion, setshowResult} from "../utils/GptSlice";
    ...
    return (
        <div className="flex justify-center">
            ...
            <div className="absolute z-20 p-5 mt-40 md:mt-30  flex flex-col   items-center ">
                ...
                <h1 className="text-3xl md:text-4xl font-bold text-white text-center">Hey {userName}, what's in your mind?</h1>

                <form className="absolute z-20 p-5 mt-5 flex flex-col  items-center" onSubmit={(e) => e.preventDefault()}>

                    <textarea 
                        placeholder="What would you like to watch today?" 
                        className="w-85 md:w-120 bg-white p-2 mt-17 md:m-5 text-2xl text-black  border-2 border-black resize-none"
                        ref={searchText} 
                        rows={2} 
                    />

                    <button className=" bg-red-700  p-1 ml-5 mt-5 md:mt-0 text-2xl text-white font-bold rounded-2xl border w-35 md:w-40" onClick={handleSearch}>Search</button>
